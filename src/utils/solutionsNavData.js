...
const CATEGORIES_BASE = [
  {
    ...
    items: [
      ...
      { id: "textile", slug: "rfidia-tex", image: "/a_rfidia/z_textile/rfidia-tex.png" },
    ],
  },
  {
    key: "assets",
...
const I18N = {
  fr: {
    ...
    items: {
      ...
      textile: { title: "RFIDIA-TEX", description: "Traçabilité unitaire du fil à la vente pour le textile et l'habillement." },
  ...
  en: {
    ...
    items: {
      ...
      textile: { title: "RFIDIA-TEX", description: "Item-level traceability from thread to sale for textile and apparel." },
  ...
  it: {
    ...
    items: {
      ...
      textile: { title: "RFIDIA-TEX", description: "Tracciabilità del singolo capo dal filo alla vendita per tessile e abbigliamento." },
